...
module Delayed
  class Worker
    cattr_accessor :job_group, :min_priority, :max_priority, :max_attempts, :max_run_time, :default_priority, :sleep_delay, :logger
    self.sleep_delay = 5
    self.max_attempts = 25
    self.max_run_time = 4.hours
    self.default_priority = 0
    self.job_group = "regular"
    ...
    def initialize(options={})
      ...
      self.class.job_group = options[:job_group] if options.has_key?(:job_group)
    end
